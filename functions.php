...
function underscores_scripts() {
	...
	wp_enqueue_style( 'underscores-style', get_template_directory_uri() . '/dist/css/style.min.css');

	wp_enqueue_script( 'underscores-script', get_template_directory() . '/dist/js/main.min.js', array(), '20120206', true);
